...
| FEATURE-002 | Interview-ecosystem improvements   | IN PROGRESS | docs/plan/FEATURE-002.md |
| - PHASE01   | `dev-workflow` skill overhaul (v1) | DONE        | (in FEATURE-002.md)      |
| - PHASE02   | `/interview` planning-only (v7)    | TODO        | (in FEATURE-002.md)      |
| - PHASE03   | `/build` current-HEAD, reviews(v2) | TODO        | (in FEATURE-002.md)      |
