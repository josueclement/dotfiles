...
require("lazy").setup({
...

	{
		...
		config = function()
			...
			-- Hop keymaps
			vim.keymap.set("n", "<leader>fw", ":HopWord<CR>", { desc = "Hop to word" })
			vim.keymap.set("n", "<leader>fc", ":HopChar1<CR>", { desc = "Hop to character" })
			vim.keymap.set("n", "<leader>fl", ":HopLine<CR>", { desc = "Hop to line" })
